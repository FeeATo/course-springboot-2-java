...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.WAITING_PAYMENT,u1); //no banco, vai ficar 3 horas atrasado em relação ao usuário UTC. O client do banco H2 mostra o horário local correspondente
